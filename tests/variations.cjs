...
assert.equal(await v3.locator('#sauna-shower').inputValue(),'indoor');
assert(await v3.locator('#sauna-shower option[value="outdoor"]').isDisabled());
assert(await v3.locator('#sauna-shower option[value="both"]').isDisabled());
assert(await v3.locator('#sauna-circulation option[value="through"]').isDisabled());
...
assert.equal(await v3.locator('#sauna-circulation').inputValue(),'wetLobby');
...
await page.screenshot({path:'studio-sauna-l-plan.png',fullPage:true});
...
assert.equal(await v3.locator('#sauna-circulation').inputValue(),'shared','Size switching removes an incompatible corridor');
