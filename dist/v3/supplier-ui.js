...
(()=>{
 ...
 function render(next){
  ...
  if(scene.optimisation){const o=scene.optimisation,p=document.createElement('p');p.textContent=isLT?`Medinės detalės: ${o.physical_wood_parts}; geometriniai tipai: ${o.orientation_specific_types} → ${o.normalised_types}. Ruošinių tyrimas pateiktas elementų PDF.`:`Wood pieces: ${o.physical_wood_parts}; geometric types: ${o.orientation_specific_types} → ${o.normalised_types}. Stock study is in the component PDF.`;content.append(p);}
