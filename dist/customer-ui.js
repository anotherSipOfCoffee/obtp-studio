...
(()=>{
 ...
 window.OBTPLang={set(value){lang=value==='en'?'en':'lt';localStorage.setItem('obtp-language',lang);apply();for(const frame of document.querySelectorAll('iframe'))frame.contentWindow?.OBTPLang?.set(lang);},get:()=>lang};
